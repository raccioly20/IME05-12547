...
knitr::opts_chunk$set(echo = TRUE, fig.retina = 3, fig.height=4, fig.width=6, dev=c("png"), fig.path="imagens/Aula01/")
...
```{r csv}
library(readr)
url <- "https://www.gov.br/anp/pt-br/centrais-de-conteudo/dados-abertos/arquivos-acervo-de-dados-tecnicos/tabela-de-pocos.csv"
...
```{r eliminando_linhas}
pocos_01 <- pocos_01 %>% drop_na(any_of(c("TERMINO","PROFUNDIDADE_MEDIDA_M")))
